...
- (void)viewDidLoad {
    ...
    _ballProgress = [[ZXYBallProgress alloc] initWithFrame:CGRectMake(215, 30, 150, 150) progress:0];
    _ballProgress.fillColor = [UIColor yellowColor];
    _ballProgress.strokeColor = [UIColor blueColor];
    [self.view addSubview:_ballProgress];
    
    _circleProgress = [[ZXYCircleProgress alloc] initWithFrame:CGRectMake(10, 437, 150, 150) progress:0];
    ...
    _waveProgress = [[ZXYWaveProgress alloc] initWithFrame:CGRectMake(215, 437, 150, 150) progress:0];
    _waveProgress.fillColor = [UIColor greenColor];
    ...
    _gradientProgress.bottomColor = [UIColor grayColor];
    [self.view addSubview:_gradientProgress];
    
    _slider = [[UISlider alloc] initWithFrame:CGRectMake(20, 620, self.view.bounds.size.width - 40, 30)];
